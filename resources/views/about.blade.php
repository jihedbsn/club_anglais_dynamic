...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="who-we-are-content">
                        <span>What set us apart ? </span>
                        <h3>Our Approach !</h3>
                        <p>The ClubAnglais approach is based on research and best practice in immersion education. In
                            English immersion programs children do not merely learn about the English language in the
                            classroom. They learn through the English language as they actively put it to use. </p>
    ...
    <div class="gallery-area pt-100 pb-70 bg-ffffff">
        <div class="container">
                        ...
                        <div class="col-lg-8">
                            <div class="feedback-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                    ...
                                    viverra accumsan lacus vel facilisis. Lorem Ipsum is simply dummy text of the printing
