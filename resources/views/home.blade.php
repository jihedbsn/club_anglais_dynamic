                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-class">
                        ...
                        <div class="class-content">
                            ...
                            <div class="class-btn">
                                <a href="pk1" class="default-btn">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-class">
                        ...
                        <div class="class-content">
                            ...
                            <div class="class-btn">
                                <a href="pk2" class="default-btn">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 offset-lg-0 offset-md-3">
                    <div class="single-class">
                        ...
                        <div class="class-content">
                            ...
                            <div class="class-btn">
                                <a href="pk3" class="default-btn">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 offset-lg-0 offset-md-3">
                    <div class="single-class">
                        ...
                        <div class="class-content">
                            ...
                            <div class="class-btn">
                                <a href="pk4" class="default-btn">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="single-choose-item">
                        ...
                        <p>Daily sessions take place from 9AM to 5PM with a lunch break and a nap time in the middle of the
                            day. </p>
                        <p>
                            The kids learn through fun and engaging activities, centered around themes appropriate to each
                            age group.

                        </p>
                        <div class="choose-btn">
                            <a href="/preschool-camp" class="default-btn">Learn More</a>
                        </div>
                    </div>
                </div>
